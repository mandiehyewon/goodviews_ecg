...
CUDA_VISIBLE_DEVICES=3 python train.py --train-mode regression --model cnn --label pcwp --pcwp-th 15 --epoch 500 --seed 2 --name pcwp15_reg_resnet18_epc500_2
CUDA_VISIBLE_DEVICES=7 python train.py --train-mode regression --model cnn --label pcwp --pcwp-th 15 --epoch 500 --seed 3 --name pcwp15_reg_resnet18_epc500_3
CUDA_VISIBLE_DEVICES=0 python train.py --train-mode regression --model cnn --label pcwp --pcwp-th 15 --epoch 500 --seed 4 --name pcwp15_reg_resnet18_epc500_4
CUDA_VISIBLE_DEVICES=3 python train.py --train-mode regression --model cnn --label pcwp --pcwp-th 15 --epoch 500 --seed 5 --name pcwp15_reg_resnet18_epc500_5
